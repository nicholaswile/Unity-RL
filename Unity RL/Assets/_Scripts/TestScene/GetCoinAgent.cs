...
public class GetCoinAgent : Agent
{
    ...
    // Floor changes color to show win or lose
    [SerializeField]
    private MeshRenderer _floor_mesh;
    [SerializeField]
    private Material _win_mat;
    [SerializeField]
    private Material _lose_mat;
    ...
    private void Lose(float reward, string msg)
    {
        ...
        _floor_mesh.material = _lose_mat;
